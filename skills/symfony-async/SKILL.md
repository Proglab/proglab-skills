...
method call. Same reasoning as `symfony-architecture`: business consequences are
...
| Handler runs old code after a deploy | `messenger:stop-workers` was skipped — see `symfony-deployment` |
