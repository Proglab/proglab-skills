...
five minutes stacks until the host dies. That rule belongs to `symfony-console` and
`symfony-async`; it is repeated here because a process manager is exactly what turns it
