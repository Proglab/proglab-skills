...
- [`symfony console` versus `php bin/console`](#symfony-console-versus-php-binconsole)
...
(`symfony-testing`, `references/database-tests.md`). `schema:create` is the stand-in only
